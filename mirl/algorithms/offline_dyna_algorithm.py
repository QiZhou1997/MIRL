...
from mirl.algorithms.offline_rl_algorithm import OfflineRLAlgorithm
...
# TODO 删除采样相关的参数
class OfflineDynaAlgorithm(OfflineRLAlgorithm, metaclass=abc.ABCMeta):
    def __init__(
            self,
            num_epochs,
            batch_size,
        ...
        o_shape = self.eval_env.observation_space.shape
        extra_fields = {
            'deltas': {
                'shape': o_shape,
                'type': np.float32,

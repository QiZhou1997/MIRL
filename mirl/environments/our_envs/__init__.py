...
register(
    ...
    entry_point='mirl.environments.our_envs.multi_goal:MultiGoal2DEnv',
    kwargs={
        'random_reset':True,
        'goals':[[5,0], [-5,0]],
        'bound': [8,5]
...
register(
    ...
    entry_point='mirl.environments.our_envs.truncated_ant:AntTruncatedObsEnv',
    max_episode_steps=1000,
)
register(
    id='HumanoidTruncatedObs-v2',
    entry_point='mirl.environments.our_envs.truncated_humanoid:HumanoidTruncatedObsEnv',
    max_episode_steps=1000,
)

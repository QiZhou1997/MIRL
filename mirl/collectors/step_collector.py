...
from mirl.collectors.base_collector import StepCollector
import mirl.torch_modules.utils as ptu
from mirl.utils.logger import logger
import time
from tqdm import tqdm

# num_train_loops_per_epoch小于episode_length会出错
...
if __name__ == "__main__":
    ...
    from mirl.policies.base_policy import UniformlyRandomPolicy
